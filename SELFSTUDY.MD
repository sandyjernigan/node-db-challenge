...
`Foreign keys` are teh type of table field that references the primary key on another table. These can be used to link a record in one table to a record in another table.
